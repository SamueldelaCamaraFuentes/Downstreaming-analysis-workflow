...
setwd(packagesdir)
#D:/Posgrado/Trabajo Fin de Master/Entrega/Codigo/Pipeline
...
#D:/Posgrado/Trabajo Fin de Master/raw_data/Resultados/Segundo_MAxquant_16experimento/combined/txt
...
top_proteins <- my_heatmap(limma, df.FNI, cond.names, conditions, whole = TRUE, Rowv = NULL, Colv = NA, col =redgreen(75), cexCol = 0.6 )
