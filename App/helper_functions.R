...
my_heatmap <- function(data, cond.names, title){
  ...
  heatmap <- heatmap(as.matrix(data[cond.names]), labRow = data$Protein, main = title, Rowv = NULL, Colv = NA, col =redgreen(75), cexCol = 0.6)
...
my_heatmap_differential <- function(limma, data, cond.names, title){
  ...
  heatmap <- heatmap(as.matrix(diferential[cond.names]),  labRow = diferential$Protein, main =title, Rowv = NULL, Colv = NA, col =redgreen(75), cexCol = 0.6)
