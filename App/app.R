...
server <- function(input, output) {
  ...
  difexpression <- reactive({
    validate(need(!is.null(input$pvaladj),
                  "Please select an option"))
    statistic_dataframe <- statistical_analysis(data(), LOG2.names(), input$displaytest, input$testid, input$repcond1, input$repcond2, input$condition1, input$condition2, input$orderdif, input$LogFCup, input$LogFCdown, input$sigcutoff, input$pvaladj)
